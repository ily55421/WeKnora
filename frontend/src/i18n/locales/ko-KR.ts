export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      newPageBtn: '새 페이지',
    rebuildLinks: '페이지 링크 다시 만들기',
    rebuildLinksDone: '페이지 링크를 다시 만들었습니다',
    rebuildLinksFailed: '페이지 링크 다시 만들기 실패',
  ...
  evaluation: {
    title: '평가',
    description: '고정된 평가 세트로 지식베이스의 검색 및 생성 품질을 평가하여 비교 가능한 정량 지표를 얻습니다.',
    introTitle: '평가 세트는 서버에서 제공합니다',
    introDescription: '평가는 서버에 내장된 QA 평가 세트(저장소의 dataset/samples 디렉터리)를 사용합니다. 지식베이스 내용이나 문서를 읽거나 수정하지 않습니다. 실행할 때마다 대화 모델과 리랭크 모델을 실제로 호출하므로 비용에 주의하세요.',
    kbLabel: '평가할 지식베이스',
    kbDescription: '평가 대상 지식베이스입니다. 기존 색인으로 검색만 수행하며 문서를 다시 파싱하지 않습니다.',
    kbPlaceholder: '지식베이스를 선택하세요',
    chatModelLabel: '대화 모델',
    chatModelDescription: '답변을 생성하는 모델로, BLEU / ROUGE 등 생성 지표에 직접 영향을 줍니다.',
    rerankModelLabel: '리랭크 모델',
    rerankModelDescription: '선택 사항입니다. 지정하면 검색 결과를 리랭크한 뒤 평가하여 리랭크 효과를 비교할 수 있습니다.',
    start: '평가 시작',
    running: '평가 중…',
    requiredHint: '먼저 지식베이스와 대화 모델을 선택하세요',
    resultTitle: '평가 결과',
    taskId: '작업 ID',
    runningHint: '평가는 백그라운드에서 실행됩니다. 이 페이지를 떠나도 나중에 결과를 확인할 수 있습니다.',
    failedFallback: '평가가 실패했으며 서버가 구체적인 원인을 반환하지 않았습니다.',
    progressPending: '평가 데이터를 준비하는 중…',
    progressLabel: '{finished}/{total} 완료',
    statusStarting: '제출 중',
    statusPending: '대기 중',
    statusRunning: '실행 중',
    statusSuccess: '완료됨',
    ...
    generationMetrics: '생성 지표',
    metricPrecision: '정확도 Precision',
    metricRecall: '재현율 Recall',
    ...
    toasts: {
      started: '평가 작업이 제출되어 백그라운드에서 실행 중입니다',
      startFailed: '평가 제출 실패: {message}',
      success: '평가 완료',
      failed: '평가 실패: {message}',
      loadKbFailed: '지식베이스 목록을 불러오지 못했습니다',
      pollTimeout: '평가가 너무 오래 걸립니다. 진행률 추적을 중단했습니다. 나중에 결과를 다시 확인하세요.',
      pollLost: '평가 진행률을 가져올 수 없습니다. 서버 재시작으로 작업이 사라졌을 수 있으니 다시 실행하세요.'
    }
  },
  chatHistorySettings: {
    title: '메시지 관리',
