export default {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      newPageBtn: '新建页面',
    rebuildLinks: '重建页面链接',
    rebuildLinksDone: '页面链接已重建',
    rebuildLinksFailed: '重建页面链接失败',
  ...
  evaluation: {
    title: '效果评测',
    description: '用固定评测集对知识库跑一次检索与生成质量评估，得到可对比的量化指标。',
    introTitle: '评测集由服务端提供',
    introDescription: '评测使用服务端内置的 QA 评测集（仓库 dataset/samples 目录），不会读取或修改你的知识库内容，也不会改动其中的文档。运行一次会真实调用对话模型与重排模型，请注意成本。',
    kbLabel: '评测知识库',
    kbDescription: '选择要被评测的知识库。评测会基于它现有的索引做检索，不会重新解析文档。',
    kbPlaceholder: '请选择知识库',
    chatModelLabel: '对话模型',
    chatModelDescription: '用于生成回答的模型，直接影响 BLEU / ROUGE 等生成类指标。',
    rerankModelLabel: '重排模型',
    rerankModelDescription: '可选。选择后检索结果会先经过重排再评测，用于对比重排带来的收益。',
    start: '开始评测',
    running: '评测中…',
    requiredHint: '请先选择知识库与对话模型',
    resultTitle: '评测结果',
    taskId: '任务 ID',
    runningHint: '评测正在后台运行，可以离开本页，稍后回来重新发起或查看结果。',
    failedFallback: '评测失败，服务端未返回具体原因。',
    progressPending: '正在准备评测数据…',
    progressLabel: '已完成 {finished}/{total}',
    statusStarting: '提交中',
    statusPending: '排队中',
    statusRunning: '运行中',
    statusSuccess: '已完成',
    ...
    toasts: {
      started: '评测任务已提交，正在后台运行',
      startFailed: '提交评测失败：{message}',
      success: '评测完成',
      failed: '评测失败：{message}',
      loadKbFailed: '加载知识库列表失败',
      pollTimeout: '评测耗时过长，已停止跟踪进度，请稍后重新查看结果',
      pollLost: '无法获取评测进度，任务可能已随服务重启丢失，请重新发起评测'
    }
  },
  chatHistorySettings: {
    title: '消息管理',
