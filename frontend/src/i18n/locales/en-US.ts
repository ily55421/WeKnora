export default {
  ...
  evaluation: {
    title: 'Evaluation',
    description: 'Run a retrieval and generation quality assessment against a knowledge base using a fixed evaluation set, producing comparable quantitative metrics.',
    introTitle: 'The evaluation set is provided by the server',
    introDescription: 'Evaluation uses the QA set bundled with the server (the dataset/samples directory in the repository). It does not read or modify your knowledge base content or its documents. Each run really calls the chat and rerank models, so mind the cost.',
    kbLabel: 'Knowledge base',
    kbDescription: 'The knowledge base to evaluate. Evaluation retrieves against its existing index and does not re-parse documents.',
    kbPlaceholder: 'Select a knowledge base',
    chatModelLabel: 'Chat model',
    chatModelDescription: 'The model that generates answers. It directly drives generation metrics such as BLEU and ROUGE.',
    rerankModelLabel: 'Rerank model',
    rerankModelDescription: 'Optional. When set, retrieval results are reranked before scoring, which is how you measure the gain from reranking.',
    start: 'Start evaluation',
    running: 'Evaluating…',
    requiredHint: 'Select a knowledge base and a chat model first',
    resultTitle: 'Evaluation result',
    taskId: 'Task ID',
    runningHint: 'The evaluation runs in the background. You can leave this page and check the result later.',
    failedFallback: 'The evaluation failed and the server returned no reason.',
    progressPending: 'Preparing evaluation data…',
    progressLabel: '{finished}/{total} finished',
    statusStarting: 'Submitting',
    ...
    toasts: {
      started: 'Evaluation submitted and running in the background',
      startFailed: 'Failed to submit evaluation: {message}',
      success: 'Evaluation completed',
      failed: 'Evaluation failed: {message}',
      loadKbFailed: 'Failed to load knowledge bases',
      pollTimeout: 'The evaluation is taking too long. Progress tracking stopped; check the result again later.',
      pollLost: 'Cannot read evaluation progress. The task may have been lost when the server restarted — please run the evaluation again.'
    }
  },
  chatHistorySettings: {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      newPageBtn: 'New page',
    rebuildLinks: 'Rebuild page links',
    rebuildLinksDone: 'Page links rebuilt',
    rebuildLinksFailed: 'Failed to rebuild page links',
